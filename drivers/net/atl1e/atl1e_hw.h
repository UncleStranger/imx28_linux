...
#define MII_ry
Mar 17 08:41:01 ubuntu sm-msp-queue[1612]: unable to qualify my own domain name (ubuntu) -- using short name
Mar 17 08:50:01 ubuntu /USR/SBIN/CRON[1984]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:00:02 ubuntu /USR/SBIN/CRON[2189]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:00:02 ubuntu /USR/SBIN/CRON[2192]: (smmsp) CMD (test -x /etc/init.d/sendmail && /usr/share/sendmail/sendmail cron-msp)
Mar 17 09:00:02 ubuntu /USR/SBIN/CRON[2190]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd hourly 2>/dev/null)
Mar 17 09:00:02 ubuntu sm-msp-queue[2223]: My unqualified host name (ubuntu) unknown; sleeping for retry
Mar 17 09:01:02 ubuntu sm-msp-queue[2223]: unable to qualify my own domain name (ubuntu) -- using short name
Mar 17 09:10:01 ubuntu /USR/SBIN/CRON[2881]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:17:01 ubuntu /USR/SBIN/CRON[3070]: (root) CMD (   cd / && run-parts --report /etc/cron.hourly)
Mar 17 09:20:01 ubuntu /USR/SBIN/CRON[3216]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:20:01 ubuntu /USR/SBIN/CRON[3217]: (smmsp) CMD (test -x /etc/init.d/sendmail && /usr/share/sendmail/sendmail cron-msp)
Mar 17 09:20:01 ubuntu sm-msp-queue[3256]: My unqualified host name (ubuntu) unknown; sleeping for retry
Mar 17 09:21:01 ubuntu sm-msp-queue[3256]: unable to qualify my own domain name (ubuntu) -- using short name
Mar 17 09:30:01 ubuntu /USR/SBIN/CRON[3676]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:40:01 ubuntu /USR/SBIN/CRON[3870]: (smmsp) CMD (test -x /etc/init.d/sendmail && /usr/share/sendmail/sendmail cron-msp)
Mar 17 09:40:01 ubuntu sm-msp-queue[3888]: My unqualified host name (ubuntu) unknown; sleeping for retry
Mar 17 09:40:01 ubuntu /USR/SBIN/CRON[3898]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 09:41:01 ubuntu sm-msp-queue[3888]: unable to qualify my own domain name (ubuntu) -- using short name
Mar 17 09:50:01 ubuntu /USR/SBIN/CRON[4351]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 10:00:01 ubuntu /USR/SBIN/CRON[4567]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd hourly 2>/dev/null)
Mar 17 10:00:01 ubuntu /USR/SBIN/CRON[4571]: (root) CMD ([ -x /usr/sbin/update-motd ] && /usr/sbin/update-motd 2>/dev/null)
Mar 17 10:00:01 ubuntu /USR/SBIN/CRON[4570]: (smmsp) CMD (test -x /etc/init.d/sendmail && /usr/share/sendmail/sendmail cron-msp)
Mar 17 10:00:01 ubuntu sm-msp-queue[4619]: My unqualified host name (ubuntu) unknown; sleeping for retry
Mar 17 10:01:01 ubuntu sm-msp-queue[4619]: unable to qualify my own domain name (ubuntu) -- using short name
Mar 17 10:09:52 ubuntu kernel: [22290.441730] usb 1-1: USB disconnect, address 5
Mar 17 10:09:52 ubuntu kernel: [22290.444294] e1000: eth1: e1000_watchdog: NIC Link is Down
Mar 17 10:09:52 ubuntu NetworkManager: <info>  (eth1): carrier now OFF (device state 8) 
Mar 17 10:09:52 ubuntu NetworkManager: <info>  (eth1): device state change: 8 -> 2 
Mar 17 10:09:52 ubuntu NetworkManager: <info>  (eth1): deactivating device (reason: 40). 
Mar 17 10:09:52 ubuntu NetworkManager: <info>  eth1: canceled DHCP transaction, dhcp client pid 28125 
Mar 17 10:09:52 ubuntu NetworkManager: <WARN>  check_one_route(): (eth1) error -34 returned from rtnl_route_del(): Sucess  
Mar 17 10:09:52 ubuntu avahi-daemon[2709]: Withdrawing address record for 10.42.42.32 on eth1.
Mar 17 10:09:52 ubuntu avahi-daemon[2709]: Leaving mDNS multicast group on interface eth1.IPv4 with address 10.42.42.32.
Mar 17 10:09:52 ubuntu avahi-daemon[2709]: Interface eth1.IPv4 no longer relevant for mDNS.
Mar 17 10:09:52 ubuntu kernel: [22291.008963] usb 1-1: new full speed USB device using ohci_hcd and address 6
Mar 17 10:09:52 ubuntu kernel: [22291.259679] usb 1-1: configuration #1 chosen from 1 choice
Mar 17 10:09:53 ubuntu kernel: [22291.280372] input: VirtualBox USB Tablet as /
							 */
